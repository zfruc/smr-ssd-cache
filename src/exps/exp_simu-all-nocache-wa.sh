...
#Setting:	define NO_REAL_DISK_IO, NO_CACHE, SIMU_NO_DISK_IO
...
do
	rm -f /dev/shm/*
	/home/smr/smr-ssd-cache 0 0 $i 0 0 ${cache_blksize[$i]} ${fifo_blksize[$i]} 0 1 0 > /home/outputs/pore_test_outputfiles/exp/nocache-wa-$i.out
done
