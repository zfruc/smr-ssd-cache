...
extern double time_read_fifo;
extern double time_write_fifo;
extern double time_read_smr;
extern double time_write_smr;
...
extern off_t GetSMROffsetInBandFromSSD(FIFODesc *ssd_hdr);
